<template>
  <div class="planner-container">
    <div class="set-view">
      <i class="fas fa-bars" @click="view = 'single'" :class="{active :view === 'single'}"></i>
      <i class="fas fa-table" @click="view = 'week'" :class="{active :view === 'week'}"></i>
    </div>
    <AddTask v-if="addTask" v-on:toggle="toggle('addTask')" />
    <div :class="['addTask', view]">
      ...
      <ColorLabels :taskColor="taskColor" :userData="userData" :view="view" />
    </div>
    <WeekView v-if="view === 'week'" :date="date" :month="month" :currentDay="day" />
    <DailyView
      :userData="userData"
